...
面向中文巴萨球迷的非官方网站。当前版本包含诺坎普高清轮播、官方一线队定妆照与完整档案、近五赛季比赛、俱乐部历史、历史三大榜单、官方时事资讯，以及可逐步接入免费阵容、事件和球员单场数据的比赛详情页。
...
- `players.html`：球员高清轮播、23 名官方一线队球员、定妆照、个人资料、简介与荣誉
- `fixtures.html`：2021/22—2025/26 共 262 场比赛档案、赛季/赛事筛选、搜索和双方真实队徽
- `match.html`：比分、足球场阵型、比赛事件和球员单场数据界面
- `history.html`：1899 年至今的 13 段历史时间轴与完整冠军荣誉目录
...
该命令会更新 OpenFootball 的五赛季比赛结果、巴萨官方阵容和本地高清图片，并重新生成 `data/site-data.js`。
